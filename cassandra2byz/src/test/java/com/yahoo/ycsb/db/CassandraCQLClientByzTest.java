 ...
 */
public class CassandraCQLClientByzTest {
  ...
  private CassandraCQLClientByz client;
  ...
  public void setUpClient() throws Exception {
    ...
    workload.init(p);
    client = new CassandraCQLClientByz();
  ...
  private void insertRow() {
    ...
    insertStmt.value(CassandraCQLClientByz.YCSB_KEY, rowKey);
  ...
  public void testRead() throws Exception {
    ...
    assertThat(strResult, hasEntry(CassandraCQLClientByz.YCSB_KEY, DEFAULT_ROW_KEY));
  ...
  public void testUpdate() throws Exception {
    ...
    final Select selectStmt =
        QueryBuilder.select("field0", "field1")
            .from(TABLE)
            .where(QueryBuilder.eq(CassandraCQLClientByz.YCSB_KEY, key))
            .limit(1);
